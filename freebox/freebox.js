...
var commands = {
  ...
  'soundDown'      : { key: 'vol_dec*20', tts: "je baisse le son de la fribox"},
  'soundUp'        : { key: 'vol_inc*20', tts: "je monte le son de la frebox"},
...
exports.action = function(data, callback, config, SARAH){
  ...
  url = buildURL(_url+'&cour=true&key=', data.key.split('').join('|'));
